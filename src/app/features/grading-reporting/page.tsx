...
import { ChevronDown, Search, Edit, Calculator, FileText } from 'lucide-react';
...
export default function GradingReportingPage() {
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <main className="flex-1 py-8 lg:py-12">
          <div className="container mx-auto px-4">
            <PageHeader 
                title="Fitur Penilaian & Laporan" 
                description="Sistem penilaian yang fleksibel dan pembuatan laporan otomatis." 
            />
            <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
                <InfoCard
                    icon={Edit}
                    title="Input Nilai Fleksibel"
                    description="Guru dapat memasukkan berbagai jenis nilai, seperti tugas harian, kuis, ujian tengah semester (UTS), dan ujian akhir semester (UAS) dengan bobot yang dapat disesuaikan."
                />
                <InfoCard
                    icon={Calculator}
                    title="Kalkulasi Nilai Otomatis"
                    description="Sistem secara otomatis menghitung nilai akhir siswa berdasarkan bobot yang telah ditentukan, mengurangi beban kerja manual dan potensi kesalahan."
                />
                <InfoCard
                    icon={FileText}
                    title="Laporan & Transkrip"
                    description="Hasilkan laporan kemajuan siswa (rapor) dan transkrip nilai resmi secara instan dengan format standar yang siap dicetak."
                />
            </div>
             <div className="mt-12 text-center">
                <p className="text-lg text-muted-foreground">Lihat bagaimana guru mengelola penilaian dengan mudah.</p>
