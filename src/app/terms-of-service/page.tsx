    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <main className="flex-1 py-8 lg:py-12">
          <div className="container mx-auto px-4 max-w-4xl">
              <PageHeader title="Ketentuan Layanan" description="Terakhir diperbarui: 25 Juli 2025" />
              <div className="prose lg:prose-lg max-w-none">
                  <p>
                      Dengan mengakses atau menggunakan platform SIAKAD TKJ ("Layanan"), Anda setuju untuk terikat oleh Ketentuan Layanan ini. Jika Anda tidak setuju dengan bagian mana pun dari ketentuan ini, maka Anda tidak boleh mengakses Layanan.
                  </p>
                  <h2>1. Penggunaan Layanan</h2>
                  <p>
                      Anda setuju untuk tidak menyalahgunakan Layanan. Penyalahgunaan mencakup, namun tidak terbatas pada, mencoba mendapatkan akses tidak sah ke sistem kami atau menyebarkan konten yang melanggar hukum.
                  </p>
                  ...
                  <h2>3. Penghentian</h2>
                  <p>
                      Kami dapat menghentikan atau menangguhkan akses ke Layanan kami segera, tanpa pemberitahuan atau kewajiban sebelumnya, dengan alasan apa pun, termasuk jika Anda melanggar Ketentuan.
                  </p>
                   <h2>4. Perubahan pada Ketentuan</h2>
                  <p>
                      Kami berhak, atas kebijakan kami sendiri, untuk mengubah atau mengganti Ketentuan ini kapan saja.
                  </p>
              </div>
          </div>
        </main>
